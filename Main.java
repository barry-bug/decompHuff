...
//	private static final String testString = ;
	...
	//	String content = Files.readString(Paths.get(path));
		...
		/*on recupere le texte qu'on souhaite traiter sous forme de string (voir classe jjj)*/
		String texte= jjjjj.readFile("mettre ici le chemin .txt", StandardCharsets.UTF_8);
